...
(function() {
  var CLOUD, CROSS, CustomRandom, LINE, POOL, attrStr, attrib, buildingGroup, cachedRandomConstant, cachedRandomMaximum, cityGroup, curLinkIndex, d, darkBackground, darkBlueGreen, darkForestGreen, darkerBlueGreen, defaultStart, dullBlue, dullGrey, dullYellow, e, forestGreen, forestWoods, g, getPointAlignedToGrid, getRectsIn, growSeed, hash, indexSizeTable, layerGroups, linkPath, mBackground, mBlack, mBlue, mGrey, mRed, mYellow, outerGroup, peopleGroup, recallCellProperty, rememberCellProperty, sageStreak, start, tiles, veryDarkYellow, w, waterGroup, x, y;
